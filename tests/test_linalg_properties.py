...
class TestTrace:
    def test_result_matches_numpy(self):
        ...
        with BudgetContext(flop_budget=10**6):
            from whest.linalg import trace
...
class TestSlogdet:
    def test_result_matches_numpy(self):
        A = numpy.array([[1.0, 2.0], [3.0, 4.0]])
        with BudgetContext(flop_budget=10**6):
            from whest.linalg import slogdet
...
class TestVectorNorm:
    def test_result_matches_numpy(self):
        x = numpy.array([3.0, 4.0])
        with BudgetContext(flop_budget=10**6):
            from whest.linalg import vector_norm
...
class TestMatrixNorm:
    def test_result_matches_numpy(self):
        ...
        with BudgetContext(flop_budget=10**6):
            from whest.linalg import matrix_norm
...
class TestMatrixRank:
    def test_result_matches_numpy(self):
        ...
        with BudgetContext(flop_budget=10**6):
            from whest.linalg import matrix_rank
