...
class TestHistogram2dTupleBinsNonInt:
    ...
    def test_tuple_bins_with_arrays(self):
        ...
        with BudgetContext(flop_budget=10**6) as budget:
            from mechestim._counting_ops import histogram2d
...
class TestHistogramddNonIntBins:
    ...
    def test_list_bins_with_arrays(self):
        ...
        with BudgetContext(flop_budget=10**6) as budget:
            from mechestim._counting_ops import histogramdd
...
class TestApplyAlongAxis:
    ...
    def test_basic(self):
        ...
        with BudgetContext(flop_budget=10**6) as budget:
            from mechestim._counting_ops import apply_along_axis
...
class TestApplyOverAxes:
    ...
    def test_basic(self):
        ...
        with BudgetContext(flop_budget=10**6) as budget:
            from mechestim._counting_ops import apply_over_axes
...
class TestPiecewise:
    ...
    def test_basic(self):
        ...
        with BudgetContext(flop_budget=10**6) as budget:
            from mechestim._counting_ops import piecewise
...
class TestValidateNdarray:
    ...
    def test_raises_for_list(self):
        from mechestim._validation import validate_ndarray
...
class TestCheckNanInf:
    ...
    def test_float_with_nan(self):
        ...
        assert len(w) == 1
        assert issubclass(w[0].category, MechEstimWarning)
...
class TestCoerceArrays:
    ...
    def test_coerce_multiple(self):
        from mechestim._validation import coerce_arrays
    ...
    def test_coerce_preserves_ndarray(self):
        from mechestim._validation import coerce_array
...
class TestBuildShapesEllipsis:
    ...
    def test_ellipsis_raises_without_flag(self):
        from mechestim._opt_einsum._testing import build_shapes
...
class TestBuildViewsScalar:
    ...
    def test_scalar_term(self):
        from mechestim._opt_einsum._testing import build_views
...
class TestRandEquation:
    ...
    def test_return_size_dict(self):
        from mechestim._opt_einsum._testing import rand_equation
...
class TestBuildArraysFromTuples:
    ...
    def test_basic(self):
        from mechestim._opt_einsum._testing import build_arrays_from_tuples
...
class TestMechestimArrayReverseOps:
...
class TestMechestimArrayInPlaceOps:
...
class TestMechestimArrayBitwiseOps:
    ...
    def test_rand(self):
        ...
        with BudgetContext(flop_budget=10**9):
            arr = me.array([0b1010, 0b1100], dtype=numpy.int32)
    ...
    def test_ror(self):
        ...
        with BudgetContext(flop_budget=10**9):
            arr = me.array([0b1010, 0b0001], dtype=numpy.int32)
    ...
    def test_rlshift(self):
        ...
        with BudgetContext(flop_budget=10**9):
            arr = me.array([1, 2], dtype=numpy.int32)
            ...
            arr2 = me.array([1, 2], dtype=numpy.int32)
    ...
    def test_rrshift(self):
        ...
        with BudgetContext(flop_budget=10**9):
            arr = me.array([4, 8], dtype=numpy.int32)
...
class TestArrayWrapReturnScalar:
    ...
    def test_return_scalar(self):
        from mechestim._ndarray import MechestimArray

        arr = numpy.array([42.0]).view(MechestimArray)
    ...
    def test_return_non_scalar(self):
        ...
        arr = numpy.array([1.0, 2.0]).view(MechestimArray)
...
class TestRandomChoice:
    ...
    def test_choice_without_replacement(self):
        from mechestim import random as merandom
        from mechestim._flops import sort_cost
...
class TestRandomOutputSize:
    ...
    def test_output_size_with_dims(self):
        from mechestim.random import _output_size
...
class TestLinalgSolversExtended:
    ...
    def test_inv_with_symmetric(self):
        ...
        from mechestim.linalg._solvers import inv, inv_cost
    ...
    def test_lstsq(self):
        from mechestim.linalg._solvers import lstsq
    ...
    def test_pinv(self):
        from mechestim.linalg._solvers import pinv
    ...
    def test_tensorsolve(self):
        from mechestim.linalg._solvers import tensorsolve
    ...
    def test_tensorinv(self):
        from mechestim.linalg._solvers import tensorinv
...
class TestLinalgDecompositionsExtended:
    ...
    def test_svdvals_with_k(self):
        from mechestim.linalg._decompositions import svdvals
    ...
    def test_eigvalsh(self):
        from mechestim.linalg._decompositions import eigvalsh
    ...
    def test_qr(self):
        from mechestim.linalg._decompositions import qr
...
class TestLinalgPropertiesExtended:
    ...
    def test_cond_with_p_1(self):
        from mechestim.linalg._properties import cond
    ...
    def test_matrix_rank(self):
        from mechestim.linalg._properties import matrix_rank
    ...
    def test_vector_norm(self):
        from mechestim.linalg._properties import vector_norm
...
class TestLinalgAliases:
    """Cover linalg alias functions that delegate to top-level mechestim."""

    def test_cross(self):
        from mechestim.linalg._aliases import cross
    ...
    def test_outer(self):
        from mechestim.linalg._aliases import outer
    ...
    def test_tensordot(self):
        from mechestim.linalg._aliases import tensordot
    ...
    def test_vecdot(self):
        from mechestim.linalg._aliases import vecdot
    ...
    def test_diagonal(self):
        from mechestim.linalg._aliases import diagonal
    ...
    def test_matrix_transpose(self):
        from mechestim.linalg._aliases import matrix_transpose
...
class TestFFTExtended:
    ...
    def test_hfft(self):
        from mechestim.fft._transforms import hfft
    ...
    def test_ihfft(self):
        from mechestim.fft._transforms import ihfft
    ...
    def test_irfft2(self):
        from mechestim.fft._transforms import irfft2
    ...
    def test_irfftn(self):
        from mechestim.fft._transforms import irfftn
    ...
    def test_fft2_with_s(self):
        from mechestim.fft._transforms import fft2
    ...
    def test_ifft2_with_s(self):
        from mechestim.fft._transforms import ifft2
    ...
    def test_rfft2_with_s(self):
        from mechestim.fft._transforms import rfft2
    ...
    def test_fftn_with_s_and_axes(self):
        from mechestim.fft._transforms import fftn
    ...
    def test_ifftn_with_s(self):
        from mechestim.fft._transforms import ifftn
    ...
    def test_rfftn_with_s(self):
        from mechestim.fft._transforms import rfftn
...
class TestSortingOpsExtended:
    ...
    def test_lexsort(self):
        from mechestim._sorting_ops import lexsort
    ...
    def test_partition(self):
        from mechestim._sorting_ops import partition
    ...
    def test_argpartition(self):
        from mechestim._sorting_ops import argpartition
    ...
    def test_digitize(self):
        from mechestim._sorting_ops import digitize
    ...
    def test_setdiff1d(self):
        from mechestim._sorting_ops import setdiff1d
    ...
    def test_setxor1d(self):
        from mechestim._sorting_ops import setxor1d
    ...
    def test_sort_axis_none(self):
        from mechestim._sorting_ops import sort
    ...
    def test_argsort_axis_none(self):
        from mechestim._sorting_ops import argsort
...
class TestContractPathMemoryLimit:
    ...
    def test_memory_limit_invalid_string(self):
        from mechestim._opt_einsum._contract import _choose_memory_arg
