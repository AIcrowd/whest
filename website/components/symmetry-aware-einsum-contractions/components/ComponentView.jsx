        ...
        <>
          ...
          {presentation && (
            <div className="mt-1 text-[11px] text-gray-300">
              <span className="font-semibold text-white">{presentation.label}</span>
              {presentation.tooltip?.body ? (
                <span className="text-gray-400"> — {presentation.tooltip.body}</span>
              ) : null}
            </div>
          )}
        </>
    ...
    if (hovered.kind === 'hull') {
      ...
      return (
        <>
          ...
          {presentation?.tooltip?.body ? (
            <div className="text-[11px] text-gray-300">{presentation.tooltip.body}</div>
          ) : null}
          <div className="mt-2 text-[11px] text-gray-300">
