export const EXPLORER_ACTS = [
  ...
  },
  {
    ...
    produces: 'The detected contraction symmetry group `G`, an explicit generator set, and the V/W partition over the labels — everything Act 4 needs to decompose the action.',
    ...
    bridge: 'The σ-loop pairs each row move with a label permutation π; valid pairs feed Dimino, which closes them into the full group G that Act 4 will decompose.',
