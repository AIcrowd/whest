export const EXPLORER_ACTS = [
  ...
  },
  {
    ...
    algorithm: 'Enumerate candidate σ, search for compatible π, keep valid σ, and enumerate the generated group using Dimino’s algorithm.',
  ...
  },
  {
    ...
    algorithm: 'Perform component decomposition, classify each component into cases A through E, use closed-form counting when valid, and enumerate orbits otherwise.',
    produces: 'A component-level cost model.',
