export const EXPLORER_ACTS = [
  ...
  },
  {
    ...
    algorithmTitle: "Walk the wreath, derive \u03c0’s, keep the valid ones",
    algorithm: "Enumerate elements of the wreath product \u220f_i (H_i \u2240 S_{m_i}) directly, one per identical-operand group. For each \u03c3, apply derivePi to derive a candidate label permutation. The valid non-identity \u03c0’s form a group \u2014 which is G_pt \u2014 so no further closure is required.",
    produces: "The detected pointwise symmetry group G_pt, an explicit generating set of valid \u03c0’s, and the V/W partition over the labels \u2014 everything Section 4 needs to decompose the action.",
    ...
    bridge: "Each \u03c3 in the wreath is a candidate row-permutation; derivePi verifies column-fingerprint compatibility and emits a valid \u03c0 on acceptance. The surviving \u03c0’s form G_pt directly \u2014 Section 4 decomposes its action.",
