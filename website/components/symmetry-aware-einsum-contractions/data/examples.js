...
export const EXAMPLES = [
  ...
  },
  {
    ...
    description: 'Detects block symmetry — swapping (a,b)↔(c,d). All labels free.',
  ...
  },
  {
    ...
    description: 'Same subscripts on identical operands — operand swap gives identity. All-summed Burnside',
    expectedGroup: 'W: S2{i,j}',
    caseType: 'B',
    regimeId: 'allSummed',
    color: '#64748B',
  ...
  },
  {
    ...
    description: 'Identical ops → (i↔j)(k↔l). Generators split V / W — direct product fires.',
  ...
  },
  {
    ...
    description: 'A symmetric (i↔j) crosses V/W. |V|=1 → singleton weighted Burnside',
