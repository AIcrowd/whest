...
export const EXAMPLES = [
  ...
  },
  {
    ...
    description: 'Three identical X operands → S₃ permutation of (a,b,c). |G_W|=1 so the directProduct regime\'s meaningfulness guard declines; falls to bruteForceOrbit, which enumerates the 6 V-orbits exactly.',
  ...
  },
  {
    ...
    description: 'Identical operands, matching subscripts, no declared symmetry on A — so the σ-loop finds only trivial per-tuple symmetry. All-summed Burnside with |G|=1 gives μ = α = n² (one multiplication per (i,j) cell).',
    expectedGroup: 'trivial',
    regimeId: 'allSummed',
    color: '#64748B',
    variables: [
  ...
  },
  {
    ...
    description: 'T has C₃ on axes {i,j,k}, contracted with W on index a. |G_W|=1 on the a-axis; directProduct\'s meaningfulness guard declines. Falls to bruteForceOrbit.',
    expectedGroup: 'C3{i,j,k}',
    regimeId: 'bruteForceOrbit',
    color: '#4A7CFF',
    variables: [
  ...
  },
  {
    ...
    description: 'T has D₄ on axes {i,j,k,l}, contracted with W on index a. |G_W|=1; directProduct\'s meaningfulness guard declines. Falls to bruteForceOrbit.',
    expectedGroup: 'D4{i,j,k,l}',
    regimeId: 'bruteForceOrbit',
    color: '#4A7CFF',
    variables: [
