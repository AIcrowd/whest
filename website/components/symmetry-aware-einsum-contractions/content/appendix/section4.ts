...
const section4 = {
  ...
  slots: {
    intro: [
      ...
      p('An element of $G_{\\mathrm{f}} = G_{\\mathrm{out}} \\times \\prod_d S(W_d)$ acts by applying an output relabeling on $V$ and an independent same-domain dummy renaming on $W$. This is a symmetry of the completed formal expression. It is not automatically a symmetry of the accumulation process.'),
    ],
    takeaway: [
      p('$G_{\\mathrm{f}}$ explains label-renaming symmetry after summation. It should not be substituted for $G_{\\mathrm{pt}}$ in the direct accumulation cost.'),
    ],
    constructionTitle: [
