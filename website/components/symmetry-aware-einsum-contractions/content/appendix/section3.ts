...
const section3 = {
  ...
  slots: {
    definitionLead: [
      p('Among the elements of $G_{\\mathrm{pt}}$, some preserve the output-label set $V_{\\mathrm{free}}$. Restricting those elements to $V_{\\mathrm{free}}$ gives the output group'),
    ...
    takeaway: [
      p('$G_{\\mathrm{out}}$ is not an extra formal artifact. It is the visible output action inherited from $G_{\\mathrm{pt}}$.'),
    ],
  },
