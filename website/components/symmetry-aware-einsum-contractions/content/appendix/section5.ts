...
const section5 = {
  ...
  slots: {
    ...
    bilinearOrbitLead: [
      p('Swapping the summed labels $k$ and $l$ sends $(0,1)$ to $(1,0)$, so $G_{\\mathrm{f}}$ places these two assignments in the same formal orbit.'),
    ],
    ...
    directOrbitLead: [
      p('The transposition $(d\\,e)$ is allowed as a dummy relabeling in $G_{\\mathrm{f}}$, so it sends $(c,d,e) = (0,1,2)$ to $(0,2,1)$. That move is formal, but it is not a pointwise symmetry of the summands.'),
    ],
    ...
    mixedOrbitLead: [
      p('Swapping the summed labels $j$ and $k$ sends $(0,1)$ to $(1,0)$, so $G_{\\mathrm{f}}$ places these two assignments in the same formal orbit.'),
    ],
