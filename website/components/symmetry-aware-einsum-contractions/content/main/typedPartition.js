...
const typedPartition = {
  ...
  slots: {
    ...
    produces: [
      p('A live decomposition of $\\alpha$ by typed equality pattern, with the engine\'s per-pattern coefficients, block structure, and projection reach. Section 9 combines these local $M_a$ and $\\alpha_a$ values into the final direct-event total.'),
    ],
  },
};
