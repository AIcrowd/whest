...
const einsumGlance = {
  ...
  slots: {
    intro: [
      ...
      p('The preset and dimension controls are global: changing them recomputes every section below from the same normalized contraction. Figure-local controls only change the view of that section; they do not change $G_{\\mathrm{pt}}$, $H$, $M$, $\\mu$, or $\\alpha$.'),
    ],
    produces: [
