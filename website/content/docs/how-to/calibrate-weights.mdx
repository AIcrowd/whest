...
*Use this page to measure per-operation FLOP weights empirically and produce a weights config file for whest.*

**You will learn:**
- How to run the benchmark suite and produce a weights JSON config
- How perf and timing measurement modes work
- How to interpret, validate, and load weight results programmatically
...
<Callout type="info" title="Expected divergence for BLAS/linalg">
