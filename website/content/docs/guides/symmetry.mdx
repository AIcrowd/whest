...
symmetry metadata algebraically through many operations. Unary pointwise ops
usually preserve symmetry. Slicing, reductions, and binary pointwise ops can
weaken it or remove it entirely.
...
|-----------|-------------|------|
| `we.exp(s3_tensor)` | `SymmetricTensor` | unary pointwise ops keep the same groups |
