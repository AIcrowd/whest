...
**You will learn:**
- How per-operation weights are measured using hardware counters
- How the overhead-subtracted correction formula produces weights
- How to interpret the full weight tables across all operation categories
