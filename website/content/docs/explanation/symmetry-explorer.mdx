...
Use this page to interactively visualize how whest detects symmetry in einsum expressions. Walk through each algorithm step with your own expressions or preset examples.
