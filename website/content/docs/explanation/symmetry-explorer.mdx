...
*Use this page to interactively visualize how whest detects symmetry in einsum expressions.*

**You will learn:**
- How to walk through each symmetry detection step with preset or custom expressions
- How the bipartite graph, incidence matrix, and sigma-loop produce symmetry groups
- How Burnside counting translates group structure into FLOP savings
