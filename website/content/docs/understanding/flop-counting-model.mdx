...
See [Exploit Symmetry Savings](../guides/symmetry) for usage details.
...
See the
[symmetry guide](../guides/symmetry)
for usage examples, and the
[subgraph symmetry explanation](./symmetry-detection)
...
[`SubgraphSymmetryOracle`](./symmetry-detection). For the
...
[Use Einsum](../guides/einsum) for examples.
...
methodology described in [FLOP Weight Calibration Results](./calibration).
The formula is:
...
[Calibrate Weights](./calibration) for how to generate
this file.
...
- [Operation Categories](./operation-categories) — which operations are free, counted, or unsupported
- [Budget Planning](../guides/budget-planning) — query costs before running
- [Calibrate Weights](./calibration) — measure per-operation weights empirically
