...
Walk through each detection step interactively with the [Symmetry Explorer](/docs/understanding/symmetry-explorer) — choose a preset example or define your own einsum expression.
