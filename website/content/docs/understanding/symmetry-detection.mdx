...
An interactive companion that visualizes the same model on a curated set of einsum expressions is available at the standalone route [/symmetry-aware-einsum-contractions/](/symmetry-aware-einsum-contractions/) — useful for building intuition before predicting your own costs.
