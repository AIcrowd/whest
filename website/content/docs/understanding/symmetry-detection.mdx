...
Walk through each detection step interactively with the [Symmetry Explorer](/symmetry-aware-einsum-contractions) — choose a preset example or define your own einsum expression.
