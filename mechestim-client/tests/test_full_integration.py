"""End-to-end integration tests for all mechestim operation categories.
...
class TestPointwise:
    ...
    def test_subtract(self):
        ...
        with me.BudgetContext(flop_budget=1_000_000):
            a = me.array([10.0, 20.0, 30.0])
            b = me.array([1.0, 2.0, 3.0])
            result = me.subtract(a, b)
    ...
    def test_multiply(self):
        ...
        with me.BudgetContext(flop_budget=1_000_000):
            a = me.array([2.0, 3.0, 4.0])
            b = me.array([5.0, 6.0, 7.0])
            result = me.multiply(a, b)
...
class TestRandom:
    ...
    def test_normal_values_are_floats(self):
        ...
        with me.BudgetContext(flop_budget=1_000_000):
            result = me.random.normal(size=[10])
            vals = result.tolist()
            assert len(vals) == 10
    ...
    def test_uniform_shape(self):
        ...
        with me.BudgetContext(flop_budget=1_000_000):
            result = me.random.uniform(size=[50])
    ...
    def test_uniform_range(self):
        ...
        with me.BudgetContext(flop_budget=1_000_000):
            result = me.random.uniform(size=[100])
            vals = result.tolist()
