...
class TestFix1EncodeArgRecursive:
    ...
    def test_encode_arg_remote_array(self):
        from whest._remote_array import RemoteArray, _encode_arg
    ...
    def test_encode_arg_remote_scalar(self):
        from whest._remote_array import RemoteScalar, _encode_arg
    ...
    def test_encode_arg_plain_value(self):
        from whest._remote_array import _encode_arg
    ...
    def test_make_proxy_encodes_tuple_args(self):
        ...
        from whest._remote_array import RemoteArray, RemoteScalar, _encode_arg
...
class TestFix2FancyIndexEncoding:
    ...
    def test_encode_remote_array_key(self):
        from whest._remote_array import RemoteArray, _encode_index_key
    ...
    def test_encode_remote_scalar_key(self):
        from whest._remote_array import RemoteScalar, _encode_index_key
...
class TestFix4RemoteScalarArithmetic:
    ...
    def test_add(self):
        from whest._remote_array import RemoteScalar
...
class TestFix8ZmqSocketReset:
    ...
    def test_send_recv_resets_on_timeout(self):
        ...
        with pytest.raises(WhestServerError, match="timeout"):
