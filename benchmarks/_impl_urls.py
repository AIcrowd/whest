...
For each operation in mechestim, finds where the FLOP cost is charged in the
...
REPO_URL = "https://github.com/AIcrowd/mechestim/blob/main"
SRC_ROOT = Path(__file__).resolve().parent.parent / "src" / "mechestim"
...
def _to_rel_path(abs_path: str) -> str:
    ...
    repo_root = SRC_ROOT.parent.parent  # up from src/mechestim
    try:
