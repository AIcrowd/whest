...
from ._parser import get_symbol
from ._typing import ArrayType, PathType, TensorShapeType
...
def rand_equation(
    ...
    size_dict = {
        get_symbol(i): np.random.randint(d_min, d_max + 1) for i in range(num_inds)
    }
