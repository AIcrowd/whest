...
from flopscope._symmetric import SymmetricTensor, validate_symmetry
...
def _make_path_cache(maxsize):
    ...
    def _compute(
        ...
        from flopscope._perm_group import Permutation
...
def einsum(
    ...
    *operands : numpy.ndarray
    ...
    if symmetry is not None and isinstance(result, _np.ndarray) and result.ndim >= 2:
        from flopscope._symmetric import validate_symmetry_groups
