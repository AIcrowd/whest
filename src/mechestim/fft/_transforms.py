...
attach_docstring(fft, _np.fft.fft, "fft", "5 \u00d7 n \u00d7 \u2308log\u2082(n)\u2309 FLOPs")
...
attach_docstring(ifft, _np.fft.ifft, "fft", "5 \u00d7 n \u00d7 \u2308log\u2082(n)\u2309 FLOPs")
...
attach_docstring(rfft, _np.fft.rfft, "fft", "5 \u00d7 (n/2) \u00d7 \u2308log\u2082(n)\u2309 FLOPs")
...
attach_docstring(irfft, _np.fft.irfft, "fft", "5 \u00d7 (n/2) \u00d7 \u2308log\u2082(n)\u2309 FLOPs")
...
attach_docstring(fft2, _np.fft.fft2, "fft", "5 \u00d7 N \u00d7 \u2308log\u2082(N)\u2309 FLOPs, N = product of transform shape")
...
attach_docstring(ifft2, _np.fft.ifft2, "fft", "5 \u00d7 N \u00d7 \u2308log\u2082(N)\u2309 FLOPs, N = product of transform shape")
...
attach_docstring(rfft2, _np.fft.rfft2, "fft", "5 \u00d7 (N/2) \u00d7 \u2308log\u2082(N)\u2309 FLOPs, N = product of transform shape")
...
attach_docstring(irfft2, _np.fft.irfft2, "fft", "5 \u00d7 (N/2) \u00d7 \u2308log\u2082(N)\u2309 FLOPs, N = product of transform shape")
...
attach_docstring(fftn, _np.fft.fftn, "fft", "5 \u00d7 N \u00d7 \u2308log\u2082(N)\u2309 FLOPs, N = product of transform shape")
...
attach_docstring(ifftn, _np.fft.ifftn, "fft", "5 \u00d7 N \u00d7 \u2308log\u2082(N)\u2309 FLOPs, N = product of transform shape")
...
attach_docstring(rfftn, _np.fft.rfftn, "fft", "5 \u00d7 (N/2) \u00d7 \u2308log\u2082(N)\u2309 FLOPs, N = product of transform shape")
...
attach_docstring(irfftn, _np.fft.irfftn, "fft", "5 \u00d7 (N/2) \u00d7 \u2308log\u2082(N)\u2309 FLOPs, N = product of transform shape")
...
attach_docstring(hfft, _np.fft.hfft, "fft", "5 \u00d7 n_out \u00d7 \u2308log\u2082(n_out)\u2309 FLOPs")
...
attach_docstring(ihfft, _np.fft.ihfft, "fft", "5 \u00d7 n_out \u00d7 \u2308log\u2082(n_out)\u2309 FLOPs")
