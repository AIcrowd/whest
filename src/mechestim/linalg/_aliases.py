...
attach_docstring(
    matmul, _np.linalg.matmul, "linalg", "0 FLOPs (delegates to mechestim.matmul)"
)
...
attach_docstring(
    cross, _np.linalg.cross, "linalg", "0 FLOPs (delegates to mechestim.cross)"
)
...
attach_docstring(
    outer, _np.linalg.outer, "linalg", "0 FLOPs (delegates to mechestim.outer)"
)
...
attach_docstring(
    ...
    "linalg",
    "0 FLOPs (delegates to mechestim.tensordot)",
)
